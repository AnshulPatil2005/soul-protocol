# spec/embeddings/similarity.py — Vector similarity functions using only stdlib.
# Created: v0.4.0 — Moved from embeddings/similarity.py to spec/ as protocol-level pure math.
