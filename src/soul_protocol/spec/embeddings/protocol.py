# spec/embeddings/protocol.py — EmbeddingProvider protocol for pluggable embedding backends.
# Created: v0.4.0 — Moved from embeddings/protocol.py to spec/ as a protocol-level primitive.
