...
Extract named entities (people, technologies, projects, places) \
...
Return JSON array:
[{{"name": "<entity>", "type": "<person|technology|project|place>", \
"relation": "<uses|builds|prefers|works_at|learns|null>"}}]"""
